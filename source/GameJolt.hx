...
{    
     ...
     */
    public static var changeState:FlxUIState = new DemoState();
    /**
    ...
    */
    ...
    public static var textArray:Array<String> = [
        "I wanna die - Kaskudek 2022",
        "Sans Gaming - teotm 2021",
        "No. - teotm (x3 times), Cheesy, Kaskudek 2021 & 2022",
        "Worship Lexi - teotm 2021",
        "Help me it's 2 am and I am bored - Kaskudek 2022",
        "Cheesy. Chart this song >:( - teotm 2021, 2022",
        "You don't understand a joke here? Ask on Discord or GameJolt - teotm 2021",
...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    override function create()
    {
        ...
        if(!login)
            {
                FlxG.sound.playMusic(Paths.music('gameJoltLoggin'),0);
        ...
        tokenText = new FlxText(0, 225, 300, "Token: (Not Password)", 20);
        ...
        signInBox = new FlxButton(0, 425, "Sign In", function()
        {
        ...
        helpBox = new FlxButton(0, 500, "GameJolt Token", function()
        {
        ...
        logOutBox = new FlxButton(0, 575, "Log Out & Close", function()
        {
            GameJoltAPI.deAuthDaUser();
        });
        logOutBox.color = FlxColor.RED /*FlxColor.fromRGB(255,134,61)*/ ;

        cancelBox = new FlxButton(0, 575, "Not Right Now", function()
        {
            FlxG.save.flush();
