...
class LanguageOption extends Option // how do i code more than two options in kade engine?
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.langPlEn = !FlxG.save.data.langPlEn;
		display = updateDisplay();
		return true;
	}
...
class BETADCIUsomeTrioCharacterChanging extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.betadciuSomeTrioModCharChange = !FlxG.save.data.betadciuSomeTrioModCharChange;
		display = updateDisplay();
		return true;
	}
