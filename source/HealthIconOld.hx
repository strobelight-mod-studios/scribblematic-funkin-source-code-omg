...
class HealthIcon extends FlxSprite
{
	...
	public function useOldSystem(char:String)
	{
		...
		animation.add('hd-senpai-happy',        [166, 167], 0, false, isPlayer);
		animation.add('hd-senpai-angry',        [167, 167], 0, false, isPlayer);
		animation.add('hd-spirit',              [168, 169], 0, false, isPlayer);
		...
		animation.add('whittyCrazy',            [254, 255], 0, false, isPlayer);
