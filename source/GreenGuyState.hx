...
class GreenGuyState extends MusicBeatState
{
	...
	{
		FlxG.sound.playMusic(Paths.music('gumballSonicThreeAndKnux'));

		var sonicThree:FlxSprite = new FlxSprite().loadGraphic(Paths.image('noWay'));
		add(sonicThree);

		textNumber1 = new FlxText(0, 0, FlxG.width, 32);
		textNumber1.setFormat(Paths.font("undertale.ttf"), 32, FlxColor.WHITE, CENTER);
		textNumber1.text = "\nWOAH WOAH WOAH! Slow down bud. I see you trying to access one of Goblock’s BETADCIUs, well nice try man
	...
	override function update(elapsed:Float)
	{
        ...
        {
            fancyOpenURL("https://www.youtube.com/watch?v=LqxqZ6FXd3A/"); // SiIvaGunner Gumball Bonus - Sonic the Hedgehog 3 & Knuckles 
        }
	}
